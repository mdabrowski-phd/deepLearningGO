...
class GoDataProcessor:
    def __init__(self, encoder='simple', data_directory='E:/MACHINE_LEARNING/DeepLearningGoGame/dlgo_MD/dlgo/data/KGS_data'):
        self.encoder_string = encoder
        self.encoder = get_encoder_by_name(encoder, 19)
        self.data_dir = data_directory

#%% Listing 7.16 The paralell version of load_go_data can optionally return a generator
...
#%% Listing 7.7 Processing Go records stores in zip files into encoded features and labels
