...
class GoDataProcessor:
    def __init__(self, encoder='oneplane', data_directory='E:/MACHINE_LEARNING/DeepLearningGoGame/dlgo_MD/dlgo/data/KGS_data'):
        self.encoder = get_encoder_by_name(encoder, 19)
        self.data_dir = data_directory

#%% Listing 7.6 load_go_data loads, processes, and stores data
    def load_go_data(self, data_type='train',  # train or test
                     num_samples=1000):  # number of loading games
